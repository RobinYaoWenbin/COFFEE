...
class solu_solve:
    def __init__(self):
        pass
    @staticmethod
    def get_solu(logger , file_path,ts,max_di,is_sample,sample_num,research_hour, num_search_workers,is_save,save_data_path,save_data_prefix):
        ...
        for i in range(len(file_name_list)):
            ...
            tmp_obj = opt_solve_SAT.solve(opt_trips_file=file_path+file_name_list[i],
                        ts=ts, max_di=max_di,
                        is_sample=is_sample, sample_num=sample_num, research_hour=research_hour, num_search_workers=num_search_workers, logger=logger)
...
if __name__ == "__main__":
    ...
    # obj = solu_solve.get_solu(logger=logger, file_path="E:\\study_e\\analysis_of_IBTDM\\data\\optim_data\\optim_trips_spilt_morning\\",
    #                           ts=15,max_di=1,is_sample=True,sample_num=10,research_hour=14, num_search_workers=4,
    #                           is_save=True,save_data_path="E:\\study_e\\analysis_of_IBTDM\\data\\optim_data\\trip_solution_morning\\",
    ...
    #                           ts=15, max_di=1, is_sample=False, sample_num=None, research_hour=14, num_search_workers=12,
    #                           is_save=True,
