...
class trip_dis:
    ...
    def get_free_speed_trip_file(OD_file_with_free_speed,trip_after_pol,data_save_file):
        ...
        df_trip['tss'] = df_trip['tss'] + df_trip['delay']
...
if __name__ == "__main__":
    # trip_dis.get_free_speed_trip_file(OD_file_with_free_speed="E:\\study_e\\analysis_of_IBTDM\\data\\simu_pol_eva_data\\OD_with_freespeed_0419.csv",
    #                                   trip_after_pol="E:\\study_e\\analysis_of_IBTDM\\data\\optim_data\\merge_solution_optim_trips_allday_419.csv",
    #                                   data_save_file="E:\\study_e\\analysis_of_IBTDM\\data\\plan_ibtdm_pol_eva_data\\trip_freespeed_after_pol.csv")
